				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=vitamin">Vitamin</a></li>
							<li><a href="index.jsp?type=Personal Care">Personal Care</a></li>
							<li><a href="index.jsp?type=Fitness & Nutrition">Fitness And Nutrition</a></li>
							<li><a href="index.jsp?type=Eye Care">Eye Care</a></li>
